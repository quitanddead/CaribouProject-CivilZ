...
_spawnChance =  0.80; // Percentage chance of event happening
...
//_hint = parseText format["<t align='center' color='#0D00FF' shadow='2' size='1.75'>Supply Crate</t><br/><t align='center' color='#ffffff'>Weapon industry lost one of it's packages, Check your Map for the Location!</t>"];
//customRemoteMessage = ['hint', _hint];
//publicVariable "customRemoteMessage";

// Send center message to users 
[nil,nil,rTitleText,"Weapon industry lost one of its packages, Check your Map for the Location!", "PLAIN",10] call RE;
