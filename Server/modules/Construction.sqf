...
//_hint = parseText format["<t align='center' color='#0D00FF' shadow='2' size='1.75'>Supply Crate</t><br/><t align='center' color='#ffffff'>UN Agency drops building supplies for Survivors, Check your Map for the Location!</t>"];
//customRemoteMessage = ['hint', _hint];
//publicVariable "customRemoteMessage";

// Send center message to users 
[nil,nil,rTitleText,"Ikea's Special Agency drops life-saving supplies for Survivors, Check your Map for the Location!", "PLAIN",10] call RE;
