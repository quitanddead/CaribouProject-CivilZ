...
/*  SUPER ADMIN HERE      */ _SuperLevel_List = ["6870978","88588934","66282950"]; //do not have a , at the end.
/*  BANNED PLAYER HERE    */ _BLOCKED =         ["0","0","0"]; //do not have a , at the end.
/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = "Enjoy!"; //do not use " in this text.
/*  Bottom esc menu TXT   */ _LowerTop = "Epoch + Overwatch"; //do not use " in this text.
/*  Bottom esc menu TXT2  */ _LowerBottom = "by xBowBii and Randy"; //do not use " in this text.
