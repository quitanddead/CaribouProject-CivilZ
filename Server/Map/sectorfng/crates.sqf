...
if (true) then
{
  ...
  //Add Cargo
  _this addWeaponCargoGlobal ["RH_m4sd",2];
  _this addWeaponCargoGlobal ["RH_mk22vsd",2];
  _this addWeaponCargoGlobal ["RH_oc14sd",2];
  _this addWeaponCargoGlobal ["RH_svu",2];
  _this addWeaponCargoGlobal ["RH_rk95sdaim",2];
  _this addWeaponCargoGlobal ["RH_uspsd",2];
  _this addWeaponCargoGlobal ["RH_deagleg",2];
  _this addWeaponCargoGlobal ["RH_krisssd",2];
  _this addWeaponCargoGlobal ["BAF_LRR_scoped_W",2];
  _this addWeaponCargoGlobal ["G36K_camo",2];
  _this addWeaponCargoGlobal ["G36_C_SD_camo",2];
  _this addWeaponCargoGlobal ["Binocular_Vector",1];
  _this addWeaponCargoGlobal ["ItemGPS",1];

  _this addmagazineCargoGlobal ["RH_20Rnd_762x51_hk417",40];
  _this addmagazineCargoGlobal ["5Rnd_86x70_L115A1",10];
  _this addmagazineCargoGlobal ["vil_10Rnd_762x54_SV",10];
  ...
  _this addmagazineCargoGlobal ["RH_15Rnd_9x19_uspsd",10];
  _this addmagazineCargoGlobal ["30Rnd_556x45_G36SD",20];
