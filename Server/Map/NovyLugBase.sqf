...
if (true) then
    ...
    IF (TRUE) THEN
    {
      _this = createVehicle ["Fort_Barricade_EP1", [9527.3037, 11363.569, -1.5258789e-005], [], 0, "CAN_COLLIDE"];
      _vehicle_101 = _this;
      _this setDir -46.409794;
      _this setPos [9527.3037, 11363.569, -1.5258789e-005];
    };
     
    _vehicle_103 = objNull;
    IF (TRUE) THEN
    {
      _this = createVehicle ["Fort_Barricade_EP1", [9620.1006, 11263.18, -7.6293945e-005], [], 0, "CAN_COLLIDE"];
      _vehicle_103 = _this;
      _this setDir -46.409794;
      _this setPos [9620.1006, 11263.18, -7.6293945e-005];
    };
